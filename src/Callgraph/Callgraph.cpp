...
Callgraph::Callgraph(const Module &M, ptr::PointsToSets const &PS) {
...
void Callgraph::handleCall(const Function *parent, const CallInst *CI,
  ...
  for (CalledFunctions::const_iterator I = G.begin(), E = G.end(); I != E;
       ++I) {
